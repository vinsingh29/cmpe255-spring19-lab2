...
Original file is located at
    https://colab.research.google.com/drive/1kgs1E9Ic1OBez3N6voE6AcYOPhbMYTYm
"""
...
def mean_num_friends(x):
    ...
    print("mean using numpy lib= %f" %mean_numpy)
...
def median_num_friends(x):
    ...
    print("median using numpy lib = %f" %median_numpy)
